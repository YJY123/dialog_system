...
# -*- coding: utf-8 -*-
'''
FilePath: /dialog_system/generative/config_distil.py
...
def parse(opt=None):
    ...
    parser.add_argument(
        ...
        type=str,
        help="The output directory where the log information will be written."
    )
    # Other parameters
    ...
    parser.add_argument('--tuned_checkpoint_T',
                        type=str,
                        default=os.path.join(root_path, 'model/generative/bert.model.epoch_new.3'))
    parser.add_argument('--tuned_checkpoint_S', type=str, default=os.path.join(root_path, 'model/generative/gs9558.pkl'))
